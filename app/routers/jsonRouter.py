...
@jsonRouter.get("/ld/genome_builds/{genome_build}/references/{reference}/populations/{population}/variants")
async def get_ld(
    genome_build: str,
    reference: str,
    population: str,
